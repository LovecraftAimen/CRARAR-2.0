...
import { 
  PawPrint, User, ShieldCheck, Clock, X, Info, Phone, Calendar, Search, ChevronLeft, ChevronRight, MapPin, AlertTriangle, Stethoscope, Pill, FileText, CheckCircle2, Edit, Trash2, Scissors, Activity
} from 'lucide-react';
            ...
            <div className="space-y-6">
              {animalAtendimentos.map((at) => (
                <div key={at.id} className="rounded-[32px] border border-slate-100 bg-white p-6 md:p-8 shadow-sm transition-all hover:shadow-md border-l-4 border-l-crarar-primary">
                  ...
                  {(at.observacoes || at.proximo_retorno || at.obito || at.castracao || at.cirurgia) && (
